...
<!--end header-->
    ...
    <!-- <div class="container-fluid">
      ...
      -->
        ...
        <div class="feature-1 pricing h-100 text-center" style="background-color: #004643;">
            ...
            <h2 class="my-4 heading">yesnt</h2>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis ipsum odio minima tempora animi iure.</p>
          </div>
        </div>
      </div>
    ...
    <!--maybe actual now <div class="site-section block-13">-->
...
<!-----------------anggota - anggota --------->
    ...
    <div class="row align-items-stretch">
        <div class="col-md-6 col-lg-3 mb-4 mb-lg-4">
            <div class="unit-4 d-flex flex-column align-items-center text-center">
                <div class="unit-4-icon mb-4">
                    <img src="images/iya.png" width="200px" height="200px" alt="Gambar 1">
                </div>
                <div class="unit-4-content">
                    <p>Teks Gambar 1</p>
                </div>
            </div>
        </div>
      ...
      <div class="container-fluid spacer">
        ...
        <div class="row pt-1 mt-2 text-center">
          <div class="col-md-11">
            ...
            Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This website is made by <i class="icon-heart" aria-hidden="true"></i> a furry (hehe)
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
            </div>
          </div>
