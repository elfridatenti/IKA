...
@section('content')
    <div class="site-section bg-light pl-5 ">
      <div class="container-fluid mt-4 pl-5">
        <div class="text-left pb-1 border-primary mb-3 col-mt-12">
              <h2 class="text-primary">Gallery Video</h2>
        </div>
    ...
    <!---dwada-->
          <div class="mt-4 ml-4 mr-4">
            ...
            <iframe width="100px" height="400px" src="https://www.youtube.com/embed/{{$data->video}}" frameborder="0" allowfullscreen  class="card-img-top" alt="..."></iframe>
              <div class="">
